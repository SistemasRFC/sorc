...
function CarregaGrafico(){
    $.post('../../Controller/Relatorios/RelTotalDespesaController.php',
                    ...
                    [
                        {
                            ...
                            series: [
                                    { dataField: 'VALOR', displayText: 'Total', symbolType: 'square'},
                                    { dataField: 'VLR_PAGO', displayText: 'Valor Pago', symbolType: 'square'}
                                ]
                        }
                    ]
            };
