...
include_once("Model/Relatorios/RelResumoAnualModel.php");
class RelResumoAnualController extends BaseController
{
    Public Function RelResumoAnualController(){
...
$RelResumoAnualController = new RelResumoAnualController();
?>