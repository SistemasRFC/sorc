...
include_once("Model/Relatorios/RelMediaDiariaModel.php");
class RelMediaDiariaController extends BaseController
{
    Public Function RelMediaDiariaController(){
...
$RelMediaDiariaController = new RelMediaDiariaController();
?>